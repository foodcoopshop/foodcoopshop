...
trait NumberRangeValidatorTrait
{
    ...
    public function getNumberRangeValidator(Validator $validator, string $field, int $min, int $max, string $additionalErrorMessageSuffix='', bool $showDefaultErrorMessage=true): Validator
    {
