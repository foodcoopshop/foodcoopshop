...
trait CartValidatorTrait
{
    ...
    public function isProductBulkOrderStillPossible($appAuth, $isStockProduct, $stockManagementEnabled, $deliveryRhythmType, $deliveryRhythmPossibleUntil, $productName): bool|string
    {
        $result = true;
    ...
    public function hasProductDeliveryRhythmTriggeredDeliveryBreak($appAuth, $nextDeliveryDay, $productName): bool|string
    {
        $result = true;
        if (!$appAuth->isOrderForDifferentCustomerMode() && !$appAuth->isSelfServiceModeByUrl() && !$appAuth->isSelfServiceModeByReferer() && $nextDeliveryDay == 'delivery-rhythm-triggered-delivery-break') {
    ...
    public function validateQuantityInUnitsForSelfServiceMode($appAuth, $object, $unitObject, $orderedQuantityInUnits): bool|string
    {
        $result = true;
    ...
    public function validateMinimalCreditBalance($appAuth, $grossPrice): bool|string
    {
