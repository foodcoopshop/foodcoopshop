...
<p>1.1. Für alle gegenwärtigen und zukünftigen Leistungen, die der Betreiber im Rahmen ihrer Internet-Dienstleistung unter der Domain <?php echo Configure::read('AppConfig.cakeServerName'); ?> für den Hersteller erbringt (im Folgenden gemeinsam kurz: die Leistung), gelten ausschließlich die nachfolgenden Bedingungen.</p>
...
<?php
if (Configure::read('AppConfig.db_config_FCS_USE_VARIABLE_MEMBER_FEE') && $variableMemberFeeForTermsOfUse > 0) {
    ?>
