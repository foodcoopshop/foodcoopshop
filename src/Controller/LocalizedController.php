    ...
    private function getStrings(): array
    {
        $strings = [
            ...
            'cart' => [
                ...
                'ContinueToFinishCart' => __('Continue_to_finish_cart'),
            ...
            'admin' => [
                ...
                'ErrorsOccurredWhileProductNewStatusWasChanged' => __('Errors_occurred_while_product_new_status_was_changed'),
                'MarkAsNew' => __('Mark_as_new'),
                'UnmarkAsNew' => __('Unmark_as_new'),
                'EditNewStatus' => __('Edit_new_status'),
                ...
                'AttributeInfo' => __('Products with attributes cannot be copied yet: '),
