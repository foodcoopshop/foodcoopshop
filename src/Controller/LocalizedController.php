    ...
    private function getStrings(): array
    {
        $strings = [
            ...
            'admin' => [
                ...
                'CopyProduct' => __('Copy_product?'),
                'ReallyCopyProduct' => __('Really_copy_product?'),
                'AmountOfCopies' => __('Amount_of_copies:'),
                'ErrorsOccurredWhileProductWasCopied' => __('Errors_occurred_while_product_was_copied'),
