    ...
    private function getStrings()
    {
        $strings = [
            ...
            'admin' => [
                ...
                'DoYouReallyWantToCancelProduct0' => __('Do_you_really_want_to_cancel_product_%s?'),
                'DoYouReallyWantToCancelProduct0From1' => __('Do_you_really_want_to_cancel_product_%s_from_%s?'),
                ...
                'YouSelected0ProductsForCancellation' => __('You_selected_%s_products_for_cancellation'),
