...
CREATE TABLE `fcs_manufacturer` (
  ...
  `default_tax_id_purchase_price` int(8) unsigned DEFAULT NULL,
...
CREATE TABLE `fcs_stock_available` (
  ...
  `always_available` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `default_quantity_after_sending_order_lists` int(10) unsigned DEFAULT NULL,
