    ...
    public function change()
    {
        ...
        switch(I18n::getLocale()) {
            case 'de_DE':
                ...
                break;
            case 'en_US':
                $sql = "INSERT INTO `fcs_configuration` (`id_configuration`, `active`, `name`, `text`, `value`, `type`, `position`, `locale`, `date_add`, `date_upd`) VALUES (NULL, '1', 'FCS_FOODCOOPS_MAP_ENABLED', 'Show map with other foodcoops on home?', '1', 'readonly', 'boolean', '128, 'en_US', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);";
                break;
        }
