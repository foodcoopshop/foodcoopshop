...
class TimebasedCurrency extends AbstractMigration
{
    public function change()
    {
        $this->execute("
            ...
            INSERT INTO `fcs_configuration` (`id_configuration`, `active`, `name`, `text`, `value`, `type`, `position`, `date_add`, `date_upd`) VALUES (NULL, '1', 'FCS_TIMEBASED_CURRENCY_MAX_CREDIT_BALANCE_CUSTOMER', 'Zeitwährung: Überziehungsrahmen für Mitglieder<br /><div class=\"small\">Wie viele Stunden kann ein Mitglied maximal ins Minus gehen?</div>', '0', 'number', '240', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
            INSERT INTO `fcs_configuration` (`id_configuration`, `active`, `name`, `text`, `value`, `type`, `position`, `date_add`, `date_upd`) VALUES (NULL, '1', 'FCS_TIMEBASED_CURRENCY_MAX_CREDIT_BALANCE_MANUFACTURER', 'Zeitwährung: Überziehungsrahmen für Hersteller<br /><div class=\"small\">Wie viele Stunden kann ein Hersteller maximal ins Plus gehen?</div>', '0', 'number', '250', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
