...
class CashlessPaymentAddTypeConfiguration extends AbstractMigration
{
    public function change()
    {
        ...
        $sql = "INSERT INTO `fcs_configuration` (
               ...
               VALUES (
                    NULL, '1', 'FCS_CASHLESS_PAYMENT_ADD_TYPE', '".$text."', 'manual', 'readonly', '145', '".I18n::getLocale()."', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);";
        $this->execute($sql);
        ...
        $this->execute("ALTER TABLE `fcs_payments` ADD `date_transaction_add` DATETIME NULL DEFAULT NULL AFTER `date_changed`;");
        $this->execute("ALTER TABLE `fcs_payments` ADD `transaction_text` TEXT NULL DEFAULT NULL AFTER `date_transaction_add`;");
    }
}
