...
class CartsControllerTest extends AppCakeTestCase
{
    ...
    public function testFinishOrderTimebasedCurrencyEnabled()
    {
        ...
        $this->assertEquals($order->order_details[0]->product_price,  2.31405, 'order_detail->product_price not correct');
        $this->assertEquals($order->order_details[0]->total_price_tax_incl, 2.548, 'order_detail->total_price_tax_incl not correct');
        $this->assertEquals($order->order_details[0]->total_price_tax_excl,  2.31405, 'order_detail->total_price_tax_excl not correct');
        
        $this->assertEquals($order->order_details[1]->product_price, 13.522731, 'order_detail->product_price not correct');
        $this->assertEquals($order->order_details[1]->total_price_tax_incl, 14.875, 'order_detail->total_price_tax_incl not correct');
        $this->assertEquals($order->order_details[1]->total_price_tax_excl, 13.522731, 'order_detail->total_price_tax_excl not correct');

        $this->assertEquals($order->order_details[2]->product_price, 0.445455, 'order_detail->product_price not correct');
        $this->assertEquals($order->order_details[2]->total_price_tax_incl, 0.445455, 'order_detail->total_price_tax_incl not correct');
        $this->assertEquals($order->order_details[2]->total_price_tax_excl, 0.445455, 'order_detail->total_price_tax_excl not correct');
        ...
        $this->assertEquals($order->order_details[1]->timebased_currency_order_detail->money_excl, 2.39, 'order_detail timebased_currency_order_detail->money_excl not correct');
        $this->assertEquals($order->order_details[1]->timebased_currency_order_detail->money_incl, 2.63, 'order_detail timebased_currency_order_detail->money_incl not correct');
        $this->assertEquals($order->order_details[1]->timebased_currency_order_detail->time, 0.26, 'order_detail timebased_currency_order_detail->time not correct');
        ...
        $this->assertEquals($order->order_details[2]->timebased_currency_order_detail->money_excl, 0.19, 'order_detail timebased_currency_order_detail->money_excl not correct');
        $this->assertEquals($order->order_details[2]->timebased_currency_order_detail->money_incl, 0.19, 'order_detail timebased_currency_order_detail->money_incl not correct');
        $this->assertEquals($order->order_details[2]->timebased_currency_order_detail->time, 0.02, 'order_detail timebased_currency_order_detail->time not correct');
