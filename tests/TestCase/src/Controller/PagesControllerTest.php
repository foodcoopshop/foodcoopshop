...
class PagesControllerTest extends AppCakeTestCase
{
    ...
    public function testAllSuperadminUrls()
    {
        ...
        $testUrls = [
            ...
            $this->Slug->getOrderDetailsList().'?groupBy=customer&dateFrom=02.02.2018&dateTo=02.02.2018',
            $this->Slug->getOrderDetailsList().'?groupBy=manufacturer&dateFrom=02.02.2018&dateTo=02.02.2018',
            $this->Slug->getOrderDetailsList().'?groupBy=product&dateFrom=02.02.2018&dateTo=02.02.2018',
