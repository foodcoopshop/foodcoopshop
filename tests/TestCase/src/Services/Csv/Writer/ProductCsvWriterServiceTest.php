...
class ProductCsvWriterServiceTest extends AppCakeTestCase
{
    ...
    public function testWriteWithoutPurchasePrices(): void
    {
        ...
        $this->assertEquals(Bom::Utf8 . 'Id;Produkt;Hersteller;Status;Menge;Mindestlagerstand;Einheit;"Verkaufspreis brutto";"Preis pro";Lagerwert', $lines[0]);
    ...
    public function testWriteWithPurchasePrices(): void
    {
        ...
        $this->assertEquals(10, count($lines));
        $this->assertEquals(Bom::Utf8 . 'Id;Produkt;Hersteller;Status;Menge;Mindestlagerstand;Einheit;"Einkaufspreis netto";"Preis pro";Lagerwert', $lines[0]);
