...
class ProductCsvWriterServiceTest extends AppCakeTestCase
{
    ...
    public function testWriteWithoutPurchasePrices()
    {
        ...
        $this->assertEquals(Writer::BOM_UTF8 . 'Id;Produkt;Hersteller;Status;Anzahl;Einheit;Mindestlagerstand;"Verkaufspreis brutto";"Preis pro";Lagerwert', $lines[0]);
        ...
        $this->assertEquals('351;"Lagerprodukt 2";"Demo Gemüse-Hersteller";1;999;ca. 1 kg;;15,000000;"1 kg";14.985,00', $lines[4]);
        $this->assertEquals('350-13;"Lagerprodukt mit Varianten";"Demo Gemüse-Hersteller";1;5;"0,5 kg";0;2,000000;;10,00', $lines[5]);
        $this->assertEquals('350-14;"Lagerprodukt mit Varianten";"Demo Gemüse-Hersteller";1;999;"1 kg";;4,000000;;3.996,00', $lines[6]);
        $this->assertEquals('350-15;"Lagerprodukt mit Varianten";"Demo Gemüse-Hersteller";1;999;ca. 0,5 kg;;10,000000;"1 kg";4.995,00', $lines[7]);
    ...
    public function testWriteWithPurchasePrices()
    {
        ...
        $this->assertEquals(10, count($lines));
        $this->assertEquals(Writer::BOM_UTF8 . 'Id;Produkt;Hersteller;Status;Anzahl;Einheit;Mindestlagerstand;"Einkaufspreis netto";"Preis pro";Lagerwert', $lines[0]);
        $this->assertEquals('346;Artischocke;"Demo Gemüse-Hersteller";1;97;Stück;;1,200000;;116,40', $lines[1]);
        $this->assertEquals('347;Forelle;"Demo Fleisch-Hersteller";1;999;Stück;;0,980000;"100 g";3.426,57', $lines[2]);
        $this->assertEquals('351;"Lagerprodukt 2";"Demo Gemüse-Hersteller";1;999;ca. 1 kg;;0,000000;"1 kg";0,00', $lines[3]);
        $this->assertEquals('350-13;"Lagerprodukt mit Varianten";"Demo Gemüse-Hersteller";1;5;"0,5 kg";0;1,400000;;7,00', $lines[4]);
        $this->assertEquals('350-14;"Lagerprodukt mit Varianten";"Demo Gemüse-Hersteller";1;999;"1 kg";;0,000000;;0,00', $lines[5]);
        $this->assertEquals('350-15;"Lagerprodukt mit Varianten";"Demo Gemüse-Hersteller";1;999;ca. 0,5 kg;;6,000000;"1 kg";2.997,00', $lines[6]);
