...
class CustomerCsvWriterServiceTest extends AppCakeTestCase
{
    ...
    public function testWrite()
    {
        ...
        $this->assertEquals(Writer::BOM_UTF8 . 'Id;Name;PLZ;Ort;"Straße + Nummer";Adresszusatz;Handy;Telefon;Gruppe;E-Mail;Status;Credit_balance;Bestell-Erinnerung;Guthaben-Aufladung-Erinnerung;Reg.-Datum;"Letzter Abholtag";Komm.', $lines[0]);
