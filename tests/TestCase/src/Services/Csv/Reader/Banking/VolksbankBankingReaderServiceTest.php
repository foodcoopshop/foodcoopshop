...
class VolksbankBankingReaderServiceTest extends AppCakeTestCase
{
    ...
    {
        $reader = VolksbankBankingReaderService::from(self::BANKING_READER_CSV_FILE_PATH . 'volksbank.csv');
    ...
    {
        $reader = VolksbankBankingReaderService::from(self::BANKING_READER_CSV_FILE_PATH . 'volksbank-wrong-structure.csv');
