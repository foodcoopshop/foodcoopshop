...
class ProductsController extends AdminAppController
{
    ...
    public function addProductAttribute($productId, $productAttributeId)
    {
        ...
        $messageString = 'Die Variante "' . $attributeLang . '" für den Produkt "' . $oldProduct['ProductLang']['name'] . '" vom Hersteller "' . $oldProduct['Manufacturer']['name'] . '" wurde erfolgreich erstellt.';
        $this->AppSession->setFlashMessage($messageString);
    ...
    public function add($manufacturerId)
    {
        ...
        $messageString = 'Ein neuer Produkt für "' . $manufacturer['Manufacturer']['name'] . '" wurde erfolgreich erstellt.';
        $this->AppSession->setFlashMessage($messageString);
    ...
    public function editQuantity()
    {
        ...
        $this->AppSession->setFlashMessage('Die Anzahl des Produktes <b>' . $oldProduct['ProductLang']['name'] . '</b> wurde erfolgreich geändert.');
        $this->CakeActionLog->customSave('product_quantity_changed', $this->AppAuth->getUserId(), $productId, 'products', 'Die Anzahl des Produktes <b>' . $oldProduct['ProductLang']['name'] . '</b> vom Hersteller <b>' . $oldProduct['Manufacturer']['name'] . '</b> wurde von ' . $oldProduct['StockAvailable']['quantity'] . ' auf ' . $quantity . ' geändert.');
        $this->AppSession->write('highlightedRowId', $productId);
    ...
    public function editPrice()
    {
        ...
        $this->AppSession->setFlashMessage('Der Preis des Produktes <b>' . $oldProduct['ProductLang']['name'] . '</b> wurde erfolgreich geändert.');
    ...
    public function editDeposit()
    {
        ...
        $this->AppSession->setFlashMessage('Der Pfand des Produktes "' . $oldProduct['ProductLang']['name'] . '" wurde erfolgreich geändert.');
    ...
    public function editName()
    {
        ...
        $this->AppSession->setFlashMessage('Der Produkt wurde erfolgreich geändert.');

        if ($this->params['data']['name'] != $oldProduct['ProductLang']['name']) {
            $this->CakeActionLog->customSave('product_name_changed', $this->AppAuth->getUserId(), $productId, 'products', 'Der Produkt "' . $oldProduct['ProductLang']['name'] . '" vom Hersteller "' . $oldProduct['Manufacturer']['name'] . '" wurde umbenannt in <i>"' . $this->params['data']['name'] . '"</i>.');
        }
    ...
    public function changeNewStatus($productId, $status)
    {
        ...
        $message = 'Der Produkt "' . $product['ProductLang']['name'] . '" vom Hersteller "' . $product['Manufacturer']['name'] . '" wird ' . $statusText . '.';
        $this->AppSession->setFlashMessage($message);
    ...
    public function changeStatus($productId, $status)
    {
        ...
        $this->AppSession->setFlashMessage('Der Produkt "' . $product['ProductLang']['name'] . '" wurde erfolgreich ' . $statusText . '.');

        $this->CakeActionLog->customSave($actionLogType, $this->AppAuth->getUserId(), $productId, 'products', 'Der Produkt "' . $product['ProductLang']['name'] . '" vom Hersteller "' . $product['Manufacturer']['name'] . '" wurde ' . $statusText . '.');
