...
class MyHtmlHelper extends HtmlHelper {
    ...
    public function getConfigurationDropdownOptions($name) {
        ...
        switch($name) {
            ...
            case 'FCS_SHOW_FOODCOOPSHOP_BACKLINK' :
                return array(APP_ON => 'ja', APP_OFF => 'nein');
                break;
    ...
    function getCustomerOrderBy() {
        if (Configure::read('app.customerMainNamePart') == 'lastname') {
            return array('Customer.lastname' => 'ASC', 'Customer.firstname' => 'ASC');
        } else {
            return array('Customer.firstname' => 'ASC', 'Customer.lastname' => 'ASC');
        }
    }
