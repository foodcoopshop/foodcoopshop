...
<p>1.1. Für alle gegenwärtigen und zukünftigen Lieferungen und sonstige Leistungen, die der Lieferant im Rahmen dieser Plattform (FoodCoopShop), erreichbar unter der Domain <?php echo Configure::read('app.cakeServerName'); ?>, für seine Kunden erbringt (im Folgenden gemeinsam kurz: die Leistung), gelten ausschließlich die nachfolgenden Bedingungen (im Folgenden kurz: der Vertragspartner).</p>

<p>1.2. Geschäftsbedingungen des Vertragspartners kommen nicht zur Anwendung.</p>

<h2>2. Leistungen und Entgelte</h2> 

<p>2.1. Die vom Lieferanten in der Plattform der Foodcoop (FoodCoopShop) unter der Domain <?php echo Configure::read('app.cakeServerName'); ?> dargebotenen Waren und Leistungen sind eine unverbindliche Aufforderung des Lieferanten an den Vertragspartner, ein verbindliches Anbot für die angebotenen Waren und Leistungen zu legen. Durch die Bestellung im Onlineshop legt der Vertragspartner ein solches verbindliches Anbot. Ein Vertrag zwischen dem Vertragspartner und dem Lieferanten kommt erst zustande, wenn der Lieferant dieses Angebot mit einer gesonderten Bestätigung oder durch die Hinterlegung der Ware angenommen hat.</p> 
...
<p>2.4. Rechnungen werden vom vorhandenen Guthaben abgebucht. Der Lieferant ist berechtigt, vom Vertragspartner verschuldete und ihm erwachsene Schäden geltend zu machen, insbesondere die notwendigen Kosten zweckentsprechender außergerichtlicher Betreibungs- oder Einbringungsmaßnahmen, soweit diese in einem angemessenen Verhältnis zur betriebenen Forderung stehen.</p>

<h2>3. Eigentumsvorbehalt</h2>

<p>3.1. An den vom Lieferanten gelieferten Produkten besteht Eigentumsvorbehalt des Lieferanten bis zur Bezahlung aller Forderungen aus der Geschäftsverbindung zum Vertragspartner. Der Eigentumsvorbehalt bleibt auch für den Fall der Weiterveräußerung der gelieferten Produkte durch den Vertragspartner an einen Dritten bestehen. Der Vertragspartner tritt schon jetzt jene Forderungen an den Lieferanten ab, die dem Vertragspartner aus dieser Weiterveräußerung an einen Dritten erwachsen. Daraus entstehende Gebühren gehen zu Lasten des Vertragspartners.</p> 
...
<p>Die E-Mailadresse des Lieferanten ergibt sich aus dem Impressum.</p>

<h2>6. Schlussbestimmungen</h2>

<p>6.1. Erfüllungsort für alle Leistungen aus diesem Vertrag ist der Standort des Lieferanten.</p> 
