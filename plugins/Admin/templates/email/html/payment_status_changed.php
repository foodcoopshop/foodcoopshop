...
<tbody>
        ...
        <td>
            ...
            <p>
                <?php
                   echo __('The_status_of_your_credit_upload_of_{0}_({1}_amount)_was_changed_to_{2}.', [
                ...
                <?php if ($payment->approval == -1) { ?>
                    <?php echo __('Please_compare_the_credit_upload_that_you_added_to_our_system_with_the_actual_bank_account_transfer.'); ?>
                <?php } ?>
            ...
            <p>
                <?php echo __('Here_you_find_the_link_to_add_the_credit:'); ?><br />
