...
echo '<td class="' . join(' ', $rowClasses) . '"' . $style . '>';
    ...
    echo '<span class="quantity-for-dialog">' . $productQuantityService->getFormattedAmount($isAmountBasedOnQuantityInUnits, $product->stock_available->quantity, $unitName) . '</span>';
