...
if ($deposit == '' && $groupBy == '' && count($orderDetails) > 0 && (!$identity->isCustomer() || Configure::read('app.isCustomerAllowedToModifyOwnOrders'))) {
    ...
    echo '<a id="changePickupDayOfSelectedProductsButton" class="dropdown-item" href="javascript:void(0);"><i class="fa-fw far fa-calendar-alt"></i> ' . __('Change_pickup_day') . '</a>';
}
