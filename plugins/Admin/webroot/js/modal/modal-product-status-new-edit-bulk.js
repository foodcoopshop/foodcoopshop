 ...
 */
foodcoopshop.ModalProductStatusNewEditBulk = {

    init : function() {

        var modalSelector = '#modal-product-status-new-edit-bulk';

        var button = $('#editNewStatusForSelectedProducts');
        ...
        button.on('click', function () {
            ...
            foodcoopshop.Modal.bindSuccessButton(modalSelector, function() {
                foodcoopshop.ModalProductStatusNewEditBulk.getSuccessHandler(modalSelector, 1);
            });

            $(modalSelector + ' .modal-footer .btn-danger').on('click', function() {
                foodcoopshop.Helper.addSpinnerToButton($(this), 'far fa-star');
                foodcoopshop.Helper.disableButton($(this));
                foodcoopshop.ModalProductStatusNewEditBulk.getSuccessHandler(modalSelector, 0);
            });

            $(modalSelector).on('hidden.bs.modal', function (e) {
                foodcoopshop.ModalProductStatusNewEditBulk.getCloseHandler(modalSelector);
            });
            foodcoopshop.ModalProductStatusNewEditBulk.getOpenHandler(modalSelector);
    ...
    getSuccessHandler : function(modalSelector, status) {
        ...
        foodcoopshop.Helper.ajaxCall(
            '/admin/products/editNewStatusBulk/',
            {
