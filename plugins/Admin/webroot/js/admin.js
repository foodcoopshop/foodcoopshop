...
foodcoopshop.Admin = {
    ...
    triggerFilter : function () {
        ...
        $('#container').prepend('<div id="filter-loader"><i class="fas fa-spinner fa-spin"></i></div>');
    ...
    populateDropdownWithData : function(ajaxMethod, selector, dropdown, selectedIndex, onChange) {
        dropdown.parent().find('div.filter-option-inner-inner').append('<i class="fas fa-spinner fa-spin"></i>');
