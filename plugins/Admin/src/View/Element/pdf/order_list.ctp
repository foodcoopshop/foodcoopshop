 ...
 */
if (! $bulkOrdersAllowed && Configure::read('AppConfigDb.FCS_DELIVERY_DETAILS_FOR_MANUFACTURERS') != '') {
    ...
    $html .= Configure::read('AppConfigDb.FCS_DELIVERY_DETAILS_FOR_MANUFACTURERS') . '</h2>';
}
