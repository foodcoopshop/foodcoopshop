...
<div id="payments-list">
    ...
    $this->element('addScript', array(
        'script' => Configure::read('AppConfig.jsNamespace') . ".Helper.initDatepicker();
            ...
            datefieldSelector.datepicker();" . Configure::read('AppConfig.jsNamespace') . ".Admin.init();" . Configure::read('AppConfig.jsNamespace') . ".Admin.initAddPayment('#add-payment-button-wrapper .btn-success');" . Configure::read('AppConfig.jsNamespace') . ".Admin.initDeletePayment();"
    ));
    ?>
...
if ($paymentType == 'member_fee') {
    ...
    echo $this->Form->input('Payments.months_range_' . $lastYear, array(
        'label' => '',
        'options' => $monthsRange,
        'multiple' => 'checkbox',
        'type' => 'select'
    ...
    echo $this->Form->input('Payments.months_range_' . $currentYear, array(
        'label' => '',
        'options' => $monthsRange,
        'multiple' => 'checkbox',
        'type' => 'select'
    ...
    echo $this->Form->input('Payments.months_range_' . $nextYear, array(
        'label' => '',
        'options' => $monthsRange,
        'multiple' => 'checkbox',
        'type' => 'select'
