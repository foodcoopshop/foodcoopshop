...
$helpText = '<li><b>Hallo ' . $appAuth->getUserFirstname() . '!</b></li>
        ...
        <li><b>' . Configure::read('AppConfig.db_config_FCS_BANK_ACCOUNT_DATA') . '</b></li>
...
if (Configure::read('AppConfig.isDepositPaymentCashless')) {
    $helpText .= '<li>Auch das <b>Pfand</b> wird seit dem ' . date('d.m.Y', strtotime(Configure::read('AppConfig.depositPaymentCashlessStartDate'))) . ' automatisch vom Guthaben abgezogen.</li>';
...
<?php
    ...
    echo '<th ' . (! Configure::read('AppConfig.isDepositPaymentCashless') ? 'class="hide" ' : '') . 'style="text-align:right;">Pfand</th>';
    ...
    foreach ($payments as $payment) {
        ...
        echo '<td ' . (! Configure::read('AppConfig.isDepositPaymentCashless') ? 'class="hide" ' : '') . 'style="text-align:right;" ' . $numberClass . '>';
    ...
    echo '<td ' . (! Configure::read('AppConfig.isDepositPaymentCashless') ? 'class="hide" ' : '') . 'style="text-align:right;">Pfand</td>';
