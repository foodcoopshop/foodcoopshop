...
echo $this->Form->input('Manufacturer.active', [
    'label' => 'Aktiv?',
...
echo '<div class="holiday-wrapper">';
    ...
    echo $this->Form->input('Manufacturer.is_private', [
    ...
    echo $this->Form->input('Manufacturer.send_order_list', [
    ...
    echo $this->Form->input('Manufacturer.send_ordered_product_deleted_notification', [
        'label' => 'Stornierungen',
        'type' => 'checkbox',
    ...
    echo $this->Form->input('Manufacturer.send_ordered_product_price_changed_notification', [
    ...
    echo $this->Form->input('Manufacturer.send_ordered_product_quantity_changed_notification', [
    ...
    echo $this->Form->input('Manufacturer.send_shop_order_notification', [
    ...
    if (Configure::read('appDb.FCS_USE_VARIABLE_MEMBER_FEE') && !$appAuth->isManufacturer()) {
        echo $this->Form->input('Manufacturer.variable_member_fee', [
    ...
    echo $this->Form->input('Manufacturer.default_tax_id', [
    'type' => 'select',
    ...
    if (!$appAuth->isManufacturer()) {
        echo $this->Form->input('Manufacturer.bulk_orders_allowed', [
    ...
    if (!$appAuth->isManufacturer()) {
        echo $this->Form->input('Manufacturer.id_customer', [
        'type' => 'select',
    ...
    if (isset($isAllowedEditManufacturerOptionsDropdown) && $isAllowedEditManufacturerOptionsDropdown) {
        ...
        echo $this->Form->input('Manufacturer.enabled_sync_domains', [
            'type' => 'select',
            'multiple' => true,
