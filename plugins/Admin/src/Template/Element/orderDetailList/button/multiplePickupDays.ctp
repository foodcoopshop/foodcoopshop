...
echo '<a class="btn btn-default button" href="'.$hrefMultiplePickupDay.'"><i class="fa fa-calendar-' . ($multiplePickupDayMode ? 'plus' : 'minus') .'-o"></i> ' . __d('admin', 'Multiple_pickup_days') . ': ' . $this->Html->getYesNo($multiplePickupDayMode) . '</a>';
