...
trait EditNameTrait {
    ...
    public function editName()
    {
        ...
        if ($this->getRequest()->getData('name') != $oldProduct->name) {
            ...
            $this->ActionLog->customSave('product_name_changed', $this->identity->getUserId(), $productId, 'products', $actionLogMessage);
        }
        if ($this->getRequest()->getData('unity') != $oldProduct->unity) {
            ...
            $this->ActionLog->customSave('product_unity_changed', $this->identity->getUserId(), $productId, 'products', $actionLogMessage);
        }
        if ($this->getRequest()->getData('description') != $oldProduct->description) {
            ...
            $this->ActionLog->customSave('product_description_changed', $this->identity->getUserId(), $productId, 'products', $actionLogMessage);
        }
        if ($this->getRequest()->getData('descriptionShort') != $oldProduct->description_short) {
            ...
            $this->ActionLog->customSave('product_description_short_changed', $this->identity->getUserId(), $productId, 'products', $actionLogMessage);
        }
