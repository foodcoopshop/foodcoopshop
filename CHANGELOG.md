...
### Neue Funktionen
- Bei den Rechnungen können jetzt Lagerprodukte optional ausgenommen werden (app.includeStockProductsInInvoices). Außerdem ist die Übersicht für den Finanzverantwortlichen nun unter "Aktivitäten" zu finden. / [PR#2xx](https://github.com/foodcoopshop/foodcoopshop/pull/2xx) / [I#289](https://github.com/foodcoopshop/foodcoopshop/issues/289) <a href="https://github.com/mrothauer"><img src="https://github.com/mrothauer.png" width="20"></a>
